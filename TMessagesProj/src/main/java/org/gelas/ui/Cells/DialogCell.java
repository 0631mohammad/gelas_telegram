...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            namePaint.setTypeface(AndroidUtilities.getTypeface("fonts/byekan.ttf"));

            nameEncryptedPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(15));
            nameEncryptedPaint.setColor(0xff00a60e);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface("fonts/byekan.ttf"));
            ...
            countPaint.setTypeface(AndroidUtilities.getTypeface("fonts/byekan.ttf"));
        ...
        this.statusBG.setStroke(AndroidUtilities.dp(1.0f), Color.parseColor("#000000"));
    }
    private boolean setStatusColor() {
        if (this.user == null || !this.drawStatus) {
            return false;
        }
        if(this.user!=null&&this.user.phone!=null&&this.user.phone.length()<=0)this.statusBG.setVisible(false, true);
        ...
        if (formatUserStatus.equals(LocaleController.getString("ALongTimeAgo", R.string.ALongTimeAgo))) {
            this.statusBG.setColor(Color.parseColor("#000000"));
        } else if (formatUserStatus.equals(LocaleController.getString("Online", R.string.Online))) {
            this.statusBG.setColor(Color.parseColor("#8DC73F"));
