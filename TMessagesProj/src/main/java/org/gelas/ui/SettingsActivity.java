...
import org.gelas.Pouya.Helper.GhostPorotocol;
...
import org.gelas.messenger.BuildVars;
...
import org.gelas.ui.Adapters.BaseFragmentAdapter;
import org.gelas.messenger.AnimationCompat.ViewProxy;
import org.gelas.ui.Cells.CheckBoxCell;
import org.gelas.ui.Cells.TextInfoCell;
import org.gelas.ui.Cells.EmptyCell;
import org.gelas.ui.Cells.HeaderCell;
import org.gelas.ui.Cells.ShadowSectionCell;
import org.gelas.ui.Cells.TextCheckCell;
import org.gelas.ui.Cells.TextDetailSettingsCell;
import org.gelas.ui.Cells.TextSettingsCell;
...
import org.gelas.ui.Components.AvatarDrawable;
import org.gelas.ui.Components.AvatarUpdater;
...
import org.gelas.ui.Components.NumberPicker;
...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow ||i==tabletforceoverride||i==anweringmachinactive||i==answermachinetext||i==sendtyping||i==showdateshamsi||i==showtimeago||i==ghostactivate|| i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "NewGram for Android v%s (%d) %s", pInfo.versionName, code, abi));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            ...
            if (i==answeringmachinerow||i == settingsSectionRow||i==newgeramsectionrow || i == supportSectionRow || i == messagesSectionRow || i == mediaDownloadSection || i == contactsSectionRow) {
                ...
                return 3;
            } else if (i == notificationRow ||i==answermachinetext|| i == backgroundRow || i == askQuestionRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow || i == switchBackendButtonRow || i == telegramFaqRow || i == contactsReimportRow || i == textSizeRow || i == languageRow || i == contactsSortRow || i == stickersRow || i == cacheRow || i == privacyPolicyRow) {
                return 2;
