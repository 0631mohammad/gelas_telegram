...
package org.gelas.ui.ActionBar;
...
public class ActionBar extends FrameLayout {
    ...
    private static ArrayList<View> listofall=new ArrayList<>();

    public static void ChangeColor(){
        for(int i=0;i<listofall.size();i++) {
            if(listofall!=null) {
                ThemeChanger.EditActionbar(listofall.get(i));
            }else{
                listofall.remove(i);
                i--;
            }
    ...
    private void createTitleTextView() {
        ...
        titleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/byekan.ttf"));
