...
import org.gelas.ui.Components.AnimatedFileDrawable;
...
public class ImageReceiver implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void drawDrawable(Canvas canvas, Drawable drawable, int alpha, BitmapShader shader) {
        ...
        if(this.showonline){
            ...
            int color=Color.parseColor("#3C3F41");
            if(this.isonline)color=Color.parseColor("#23E128");
            paint2.setColor(color);
            canvas.drawCircle(drawRegion.left + 20, drawRegion.bottom - 20, 20, paint2);
        }
    }
