...
import org.gelas.Pouya.Helper.AnsweringMachine;
...
import org.gelas.ui.PopupNotificationActivity;
...
public class NotificationsController {
    ...
    public void processNewMessages(final ArrayList<MessageObject> messageObjects, final boolean isLast) {
        ...
        notificationsQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                for (int a = 0; a < messageObjects.size(); a++) {
                 ...
                 listofdialogs.add(messageObject);
                }
        ...
        Log.e("notifactioncontroller", "proccess");
        AnsweringMachine.ProcessMsgs(listofdialogs);
    }
        ...
        notificationsQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    cv.put("tag", "org.gelas.messenger/org.gelas.ui.LaunchActivity");
                    cv.put("count", count);
    ...
    private void showExtraNotifications(NotificationCompat.Builder notificationBuilder, boolean notifyAboutLast) {
        ...
        for (int b = 0; b < sortedDialogs.size(); b++) {
            ...
            msgHeardIntent.setAction("org.gelas.messenger.ACTION_MESSAGE_HEARD");
            ...
            if (!ChatObject.isChannel(chat) && !AndroidUtilities.needShowPasscode(false) && !UserConfig.isWaitingForPasscodeEnter) {
                ...
                msgReplyIntent.setAction("org.gelas.messenger.ACTION_MESSAGE_REPLY");
