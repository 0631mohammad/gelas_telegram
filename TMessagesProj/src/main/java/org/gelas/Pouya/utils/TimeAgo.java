package org.gelas.Pouya.utils;

/**
 * Created by Pouya on 1/8/2016.
 */
...
public class TimeAgo {
    ...
    public static String FastGet(String Dates){
        TimeAgo s=new TimeAgo(LaunchActivity.thiscontext);
    ...
    public static String timeAgo(long millis) {
        ...
        if(context==null)context=LaunchActivity.thiscontext;
