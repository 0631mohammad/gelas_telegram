...
static const char *NativeByteBufferClassPathName = "org/gelas/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/gelas/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/gelas/tgnet/RequestDelegateInternal;Lorg/gelas/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/gelas/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/gelas/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/gelas/tgnet/ConnectionsManager"));
